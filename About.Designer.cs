namespace FunctionApproximation
{
	partial class About
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Function Approximation";
			// 
			// label2
			// 
			...
			this.label4.Text = "Nguyen Ba Dung";
			// 
			// label5
			// 
			...
			this.label5.Text = "Ngoc Viet Tien";
			// 
			// label6
			// 
			...
			this.label6.Text = "Phung Dinh Tai";
			// 
			// label7
			// 
			...
			this.label7.Text = "Version: v2.0.1";
			// 
			// label9
			// 
			...
			this.label9.Text = "It is open source project. Full source code can get at github:";
			// 
			// linkLabel1
			// 
			...
			this.linkLabel1.Text = "https://github.com/tiena2cva/NeuralNetwork";
			this.linkLabel1.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkLabel1_LinkClicked);
			// 
			// linkLabel2
			// 
			this.linkLabel2.AutoSize = true;
			this.linkLabel2.Location = new System.Drawing.Point(29, 178);
			this.linkLabel2.Name = "linkLabel2";
			this.linkLabel2.Size = new System.Drawing.Size(259, 13);
			this.linkLabel2.TabIndex = 6;
			this.linkLabel2.TabStop = true;
			this.linkLabel2.Text = "https://github.com/tiena2cva/FunctionApproximation";
			...
			this.label10.Text = "License: GNU General Public License v2.0";
			// 
			// About
			// 
